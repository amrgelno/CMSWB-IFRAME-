...
?>
<div class="watch-video"><button id="Paragraph-bt" STYLE="background:#000;" /><a href="CMS_VIDEO/insparag.mp4" target="_blank">HOW TO USE</a></button></div>
...
<div class="watch-video"><button id="Article&topic-bt" STYLE="background:#000;" /><a href="CMS_VIDEO/instopic.mp4" target="_blank">HOW TO USE</a></button></div>
...
<div class="watch-video"><button id="Boxes&categeory-bt" STYLE="background:#000;" /><a href="CMS_VIDEO/categories.mp4" target="_blank"> HOW TO USE</a></button></div>
...
<div class="watch-video"><button id="slideshow-bt"  STYLE="background:#000;"  /><a href="CMS_VIDEO/slideshow.mp4" target="_blank"> HOW TO USE</a></button></div>
...
#$upbox="update box Set cat_Name='$full_cat'  where ID=(select Min(id)  FROM  box  Where cat_type='$cat' And  Box_id='$Box_id' ) ";
...
while($column= mysqli_fetch_object($querys))          {
 ...
 $upstatic="update static SET  static_Name='$full_cat'  where  ID='$min_id' ";
...
if($Image_type=='image/jpeg' or  $Image_type=='image/png' or  $Image_type=='image/gif'  )
                                                       ...
                                                       {
move_uploaded_file ($path,$dir.$Image_name2);                                                      
#mysqli_query($connect,$upstatic);
$this->connectF()->query($upstatic);

#mysqli_query($connect,$static);
