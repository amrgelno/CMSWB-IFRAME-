...
<body>
<form  action='cat_boxboxes.php' method='post'>
...
class cat_boxboxes  extends  condb{        
...
$select="select * from  box  where  related_id = '$MAIN_ID'  And  cat_type= '$cat_type'  ";
