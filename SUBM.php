...
$MainM=$_POST['MainM_ID'];

$select="select * from submenu WHERE ID =$MainM"; 
...
?>
<form action="SUBM.php" method="post" enctype="multipart/form-data">
    ...
    <input type="SUBMIT" name="ADD" VALUE="ADD" Class="ADD" class="Mainbt1" />
    </form>
   <br/>
   <br/>
<?php
$MID = $column->ID;
$select1="select * from submenu WHERE parent_id =$MID ORDER BY  ID ASC";
  ...
  <tr>
    ...
    <input type="text" name="SUBMENU" VALUE="<?PHP echo $column->sub1menu;?>">
     ...
     <td>
       ...
       <td>
    <input type="hidden" name="SUBM_ID" VALUE="<?PHP echo $column->ID;?>">
    <input type="SUBMIT" name="UPDATE" VALUE="UPDATE" class="update" />
    </form>
    </td> 
    
    
    <td><form action="DropDown.php" method="post">
    <input type="hidden" name="SUBM_ID" VALUE="<?PHP echo $column->ID?>">
    ...
    <input type="hidden" name="Main_ID" VALUE="<?PHP echo $MID?>">    
    <input type="hidden" name="SUBM_ID" VALUE="<?PHP echo $column->ID?>">
    ...
    <td>
    <form action="edit&del_topic2.php" method="post">
    <input type="hidden" name="MainM_ID" VALUE="<?PHP echo $column->ID?>">
    <input type="SUBMIT" name="INSERT" VALUE="EDIT_TOPIC" class="EDIT" />
    </form>
    </td>
<?php
}
...
$insert="insert into submenu (sub1menu,submenuico,parent_id) VALUES ('$MainM_title','$Image_name','$MainM_ID')";
