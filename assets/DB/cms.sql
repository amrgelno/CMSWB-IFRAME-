...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2021 at 12:43 AM
...
(3, 'tagel', '', 'tagel.jpg', 1, 0, 0, '', 'Meest recente berichten', '2021-02-21 18:36:03', 0),
(2, 'stukadoor', '', 'stukadoor.jpeg', 1, 0, 0, '', 'Meest recente berichten', '2021-02-21 18:36:03', 0),
(1, 'Schilder', '', 'Schilder.jpg', 1, 0, 0, '<div class=\"clear\"></div>Meest recente berichten', 'Meest recente berichten', '2021-02-21 18:36:03', 0),
(5, 'plasterer', '', 'stukadoor-pp.jpg', 1, 0, 0, '', 'Meest recente berichten', '2021-02-21 18:36:03', 0),
(4, 'gipsplaat', '', 'gipsplaat.jpg', 1, 0, 0, '', 'Meest recente berichten', '2021-02-21 18:36:03', 0);
...
(7, '<p>sakldjklsajdklasjdklasjdkaxm,zcm,zxncmnzxmcnmzcn</p>', 2, 0, 0);
...
(6, 'trustKlusbedrijf', '', 'ezgif.com-gif-maker (24).gif', 1, NULL, NULL),
(5, 'trustKlusbedrijf', '', 'ezgif.com-gif-maker (21).gif', 1, NULL, NULL),
(4, 'trustKlusbedrijf', '', 'ezgif.com-gif-maker (22).gif', 1, NULL, NULL);
...
(6, 'honxel1', '10', 'R.jfif', '2', '', '', '<div class=\"clear\"></div>honxel', 'honxel', '2021-12-30 13:19:15', '');
...
(1, '', '<p style=\"text-align: left;\">&nbsp;</p>\r\n<p class=\"MsoNormal\" style=\"text-align: left;\"><span style=\"font-size: 20.0pt; line-height: 115%;\"><span style=\"font-family: impact, sans-serif; font-size: 8pt;\">[Type a quote from the document or the summary of an interesting point.</span></span></p>\r\n<p class=\"MsoNormal\" style=\"text-align: left;\"><span style=\"font-size: 20.0pt; line-height: 115%;\"><span style=\"font-family: impact, sans-serif; font-size: 8pt;\"> You can position the text box anywhere in the document. Use the Drawing Tools tab to change the formatting of the pull quote text box.]</span></span></p>', '', 'Schilder.jpg', 1, NULL, NULL);
...
CREATE TABLE `video` (
  ...
  `VIDO_ID` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
