...
$select_text="SELECT   *  From  cover where  relatedtopic_id= $relatedtopic_id ";
...
$select1="SELECT * from slider  where    slider.relatedtopic_id =  '$relatedtopic_id'   ";
...
$relatedtopic_id=$_GET['Topic_ID'];
$SELECT="SELECT * from topic where relatedtopic_id = '$relatedtopic_id'";
...
$SELECT="SELECT  *  from  paragraph where relatedtopic_id  = '$relatedtopic_id'";
...
<?php
  ...
  $relatedtopic_id=$_GET['Topic_ID'];
$select="SELECT   * from box  Where relatedtopic_id ='$relatedtopic_id' ORDER BY  box.ID ASC";
...
$select="select  *  from  VIDEO   Where  relatedtopic_id =$relatedtopic_id ORDER BY  VIDEO.ID ASC";
...
$relatedtopic_id=$_GET['Topic_ID'];
$select="select * from forms Where forms_id =$relatedtopic_id";
